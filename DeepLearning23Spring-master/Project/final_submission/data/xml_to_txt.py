    ...
    while i <= 2:
        if name[i].firstChild.data == 'cola':
            ...
            message = message + ' ' + '2' + ' ' + xmin[i].firstChild.data + ' '\
                      + ymin[i].firstChild.data + ' ' + xmax[i].firstChild.data +  ' '+\
                      ymax[i].firstChild.data
        elif name[i].firstChild.data == 'hongniu':
            message = message + ' ' + '3' + ' ' + xmin[i].firstChild.data + ' '\
                      + ymin[i].firstChild.data + ' ' + xmax[i].firstChild.data +  ' '+\
                      ymax[i].firstChild.data
        elif name[i].firstChild.data == 'yanqishui':
            message = message + ' ' + '4' + ' ' + xmin[i].firstChild.data + ' '\
                      + ymin[i].firstChild.data + ' ' + xmax[i].firstChild.data +  ' '+\
                      ymax[i].firstChild.data
        else:
            pass
